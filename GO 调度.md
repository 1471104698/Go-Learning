...
[阻塞状态下 M 和 G 的情况](https://blog.csdn.net/wentyoon/article/details/94390880)

当系统调用阻塞时，M OS 线程会跟 G 绑定着从 P 上解绑，此时 P 任务队列上还有 G 的话会尝试获取一个 M 来执行，如果没有的话就创建一个新的 M

当 chan 阻塞时，是用户态阻塞，那么只会将 G 挂起，M 和 P 继续绑定，M 继续从 P 中获取任务执行，等待其他 G 去唤醒挂起的 G